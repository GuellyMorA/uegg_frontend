...
                                    <span class="bg-surface position-relative text-subtitle-1 text-grey100">Seguimiento del caso</span>
                                </div>
                            </v-col>
                            <v-col cols="12" md="4">
...
                            
                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.inicialVictima" label="Inicial víctima" required :disabled="isFormDisabled" :readonly="isFormDisabled ? false : true"></v-text-field>
                            </v-col>
                            
                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.inicialAgresor" label="Inicial agresor" required :disabled="isFormDisabled" :readonly="isFormDisabled ? false : true"></v-text-field>
                            </v-col>
                            
                                                        
                            <v-col cols="12" md="12">
...
                            
                            <v-col cols="12" md="4" >
                                <v-checkbox v-model="form.remisionCasoDepartamentoMedidas" label="¿ Se remitió el caso a la Dirección Departamental para asumir medidas disciplinarias ?" required :disabled="isFormDisabled"></v-checkbox>
                            </v-col>
...
                            
                            <v-col cols="12" md="4" >
                                <v-checkbox v-model="form.solucionAvisoEstudiante" label="¿ Se informó al estudiante como se resolvió el caso ?" required :disabled="isFormDisabled"></v-checkbox>
                            </v-col>
