...
                            
                            <v-col cols="12" md="3" >
                                <v-select v-model="form.etapaPreliminar" :items="etapaPreliminarTipo" item-title="name" item-value="id" label="Etapa preliminar" return-object :disabled="isFormDisabled"></v-select>
                            </v-col>

                            <v-col cols="12" md="3" >
                                <v-text-field v-model="form.fechaAgresion" label="Fecha de la agresión" @input="onDateInput1" placeholder="DD/MM/AAAA" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>
                            
                            <v-col cols="12" md="3" >
                                <v-select v-model="form.preparatoriaImputacionFormal" :items="preparatoriaImputacionFormalTipo" item-title="name" item-value="id" label="Preparatoria imputación formal" return-object :disabled="isFormDisabled"></v-select>
                            </v-col>

                            <v-col cols="12" md="3" >
                                <v-select v-model="form.jucioAcusacionFormal" :items="jucioAcusacionFormalTipo" item-title="name" item-value="id" label="Juicio acusación formal" return-object :disabled="isFormDisabled"></v-select>
                            </v-col>                           

                            <v-col cols="12" md="3" >
                                <v-checkbox v-model="form.apelacion" label="¿ Apelación ?" required :disabled="isFormDisabled"></v-checkbox>
                            </v-col>

                            <v-col cols="12" md="3" >
                                <v-checkbox v-model="form.casacion" label="¿ Casación ?" required :disabled="isFormDisabled"></v-checkbox>
                            </v-col>

                            <v-col cols="12" md="3" >
                                <v-select v-model="form.otraFormaConclusionProceso" :items="otraFormaConclusionProcesoTipo" item-title="name" item-value="id" label="Otras formas de conclusión del proceso" return-object :disabled="isFormDisabled"></v-select>
                            </v-col> 

                            <v-col cols="12" md="3" >
                                <v-text-field v-model="form.fechaSeguimiento" label="Fecha de seguimiento" @input="onDateInput2" placeholder="DD/MM/AAAA" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>
