                ...
                <v-card-item>
                    ...
                    <v-form v-model="valid" class="">
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="3" >
                                <v-text-field v-model="form.victimaSexo" label="Sexo F/M" hide-details required :readonly="true"></v-text-field>
                            </v-col>
                            ...
                            <v-col cols="12" md="3" >
                                <v-text-field v-model="form.agresorSexo" label="Sexo F/M" hide-details required :readonly="true"></v-text-field>
                            </v-col>
