...
                                                        
                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.numeroAgresor" type="number" label="Agresor Nro." hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.codigoRda" label="Código RDA" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.carnetIdentidad" type="number" label="Número de C.I." hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.complemento"  label="Complemento" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.paterno" label="Apellido Paterno" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.materno" label="Apellido Materno" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.nombre" label="Nombre(s)" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>
                            
                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.fechaNacimiento" label="Fecha de nacimiento" @input="onDateInput2" placeholder="DD/MM/AAAA" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.edad" type="number" label="Edad" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.sexo" label="Sexo F/M" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                                                        <v-col cols="12" md="4" >
                                <v-text-field v-model="form.cargo" label="Cargo que ocupa" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.nivel" label="Nivel" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>
...
                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.correo" label="Correo electrónico" hide-details required :disabled="isFormDisabled"></v-text-field>
                            </v-col>    
